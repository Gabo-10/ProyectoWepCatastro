document.addEventListener("DOMContentLoaded", function() {
    const idsvi = document.getElementById('txtid');
    const foliosvi = document.getElementById('txtfolio');
    const nombressvi = document.getElementById('txtnombre');
    const carpetasvi = document.getElementById('txtcarpeta');
    const areasvi = document.getElementById('txtarea');
    const foliosmasvi = document.getElementById('txtfolioma');
    const verisvi = document.getElementById('txtveri');
    const tiposvi = document.getElementById('txttipo');
    const clavesvi = document.getElementById('txtclave');
    const costosvi = document.getElementById('txtcosto');
    const obssvi = document.getElementById('txtobs');
