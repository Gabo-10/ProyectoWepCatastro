...
const tablaCrearinsp = document.querySelector('.tabla-contenedor table'); // Seleccionar el elemento de la tabla dentro del elemento `.tabla-contenedor`
const filasCrearinsp = tablaCrearinsp.querySelectorAll('tbody tr');  // Obtener todas las filas de la tabla (<tr>) dentro del cuerpo de la tabla
...
inputBusqueda.addEventListener('input', function() {
  ...
  for (const fila of filasCrearinsp) {
