...
const tablaVentanilla = document.querySelector('.tabla-contenedor table'); // Seleccionar el elemento de la tabla dentro del elemento `.tabla-contenedor`
const filasVentanilla = tablaVentanilla.querySelectorAll('tbody tr');  // Obtener todas las filas de la tabla (<tr>) dentro del cuerpo de la tabla
...
inputBusqueda.addEventListener('input', function() {
  ...
  for (const fila of filasVentanilla) {
...
document.querySelectorAll('.btneliminarven').forEach(btn => {
